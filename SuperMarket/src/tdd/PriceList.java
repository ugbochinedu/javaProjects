...
public class PriceList {
    ...
    public void getUserInput() {
        ...
        if(userInput == 1){
            ...
            System.out.println("The total price of " + bookQuantity +" book(s) is " + totalBookPrice);
            System.out.println();
        } else if (userInput == 2) {
            ...
            System.out.println("The total price of " + shoeQuantity +" shoe(s) is " + totalShoePrice);
            System.out.println();
        }else if (userInput == 3){
            ...
            System.out.println("The total price of " + bagQuantity +" bag(s) is " + totalBagPrice);
            System.out.println();
        }else{
